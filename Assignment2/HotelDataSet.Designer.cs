...
namespace Assignment2 {
    ...
    public partial class HotelDataSet : global::System.Data.DataSet {
        ...
        public partial class RoomsDataTable : global::System.Data.TypedTableBase<RoomsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public RoomsRow AddRoomsRow(string RoomNumber, string RoomType, int Capacity, decimal Price) {
...
namespace Assignment2.HotelDataSetTableAdapters {
    ...
    public partial class RoomsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Rooms] WHERE (([RoomID] = @Original_RoomID) AND ([Capacity] = @Origi" +
                "nal_Capacity) AND ([Price] = @Original_Price))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Rooms] ([RoomNumber], [RoomType], [Capacity], [Price]) VALUES (@Room" +
                "Number, @RoomType, @Capacity, @Price);\r\nSELECT RoomID, RoomNumber, RoomType, Cap" +
                "acity, Price FROM Rooms WHERE (RoomID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Rooms] SET [RoomNumber] = @RoomNumber, [RoomType] = @RoomType, [Capacity] = @Capacity, [Price] = @Price WHERE (([RoomID] = @Original_RoomID) AND ([Capacity] = @Original_Capacity) AND ([Price] = @Original_Price));
SELECT RoomID, RoomNumber, RoomType, Capacity, Price FROM Rooms WHERE (RoomID = @RoomID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Assignment2.Properties.Settings.Default.HotelConnectionString;
        }
        ...
        public virtual int FillRooms(HotelDataSet.RoomsDataTable dataTable) {
        ...
        public virtual HotelDataSet.RoomsDataTable GetRoomData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
        ...
        public virtual int Delete(int Original_RoomID, int Original_Capacity, decimal Original_Price) {
        ...
        public virtual int Insert(string RoomNumber, string RoomType, int Capacity, decimal Price) {
            if ((RoomNumber == null)) {
        ...
        public virtual int Update(string RoomNumber, string RoomType, int Capacity, decimal Price, int Original_RoomID, int Original_Capacity, decimal Original_Price, int RoomID) {
            if ((RoomNumber == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string RoomNumber, string RoomType, int Capacity, decimal Price, int Original_RoomID, int Original_Capacity, decimal Original_Price) {
            return this.Update(RoomNumber, RoomType, Capacity, Price, Original_RoomID, Original_Capacity, Original_Price, Original_RoomID);
        }
    }
